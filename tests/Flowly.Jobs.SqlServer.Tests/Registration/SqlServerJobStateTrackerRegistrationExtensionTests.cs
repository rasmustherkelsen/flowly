...
namespace Flowly.Jobs.SqlServer.Tests.Registration;

public class SqlServerJobStateTrackerRegistrationExtensionTests
{
    public class AddSqlServerJobStateTracking
    {
        [Fact]
        public void WithConnectionStringName_ResolvesConnectionStringFromConfiguration()
        {
            var configuration = new ConfigurationBuilder()
                ...
                {
                    ["ConnectionStrings:JobsDb"] = "Server=cfg;Database=jobs;TrustServerCertificate=True"
                })
                .Build();
            ...
            Assert.Equal("Server=cfg;Database=jobs;TrustServerCertificate=True", ResolveConnectionString(builder.Services));
        }
        ...
        public void WithLiteralConnectionString_UsesValueDirectly()
        {
            ...
            builder.AddSqlServerJobStateTracking("Server=direct;Database=jobs;TrustServerCertificate=True");

            Assert.Equal("Server=direct;Database=jobs;TrustServerCertificate=True", ResolveConnectionString(builder.Services));
        }
    }
    ...
    public class AddJobStateTrackingClient
    {
        ...
        public void WithLiteralConnectionString_UsesValueDirectly()
        {
            ...
            builder.AddJobStateTrackingClient("Server=direct;Database=jobs;TrustServerCertificate=True");
