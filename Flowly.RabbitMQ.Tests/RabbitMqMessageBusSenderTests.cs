...
public class RabbitMqMessageBusSenderTests
{
    public class SendMessage
    {
        ...
        {
            var sender = new RabbitMqMessageBusSender("test-queue", new SpyChannel(), maxMessageSizeBytes: null);
        ...
        {
            var sender = new RabbitMqMessageBusSender("test-queue", new SpyChannel(), maxMessageSizeBytes: 1024);
        ...
        {
            var sender = new RabbitMqMessageBusSender("test-queue", new SpyChannel(), maxMessageSizeBytes: 1);
