...
namespace SimpleTransit.DatabaseModel.JobStateDatabase;
...
internal class JobStateDataContextFactory : IDesignTimeDbContextFactory<JobStateDataContext>
{
    ...
    public JobStateDataContextFactory()
    {
        ...
        var connectionString = "Data Source=localhost;Initial Catalog=SimpleTransit;User=sa;Password=Strong01;TrustServerCertificate=True";
