...
{
    internal static readonly TimeSpan HungJobThreshold = TimeSpan.FromHours(3);
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (await timer.WaitForNextTickAsync(stoppingToken))
        {
            ...
            await PerformMaintenance(scope.ServiceProvider.GetRequiredService<IJobStateRepository>());
        }
    }

    internal async Task PerformMaintenance(IJobStateRepository repository)
    {
