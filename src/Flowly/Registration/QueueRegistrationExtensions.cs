...
internal static class QueueRegistrationExtensions
{
    ...
    {
        return flowlyBuilder.AddQueueRegistration(new DeferredQueueRegistration(queueName, requiresSession), providerName);
    }
