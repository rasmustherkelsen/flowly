...
Aspire starts RabbitMQ (with management plugin), PostgreSQL (with pgAdmin), BackendProcessor, BackendFinanceProcessor, Api, and the dashboard. Open the Aspire dashboard URL printed to the console to see logs, traces, and resource health.
