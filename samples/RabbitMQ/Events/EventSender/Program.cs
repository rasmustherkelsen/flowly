...
builder.Services.AddHostedService<RaiseEventsBackgroundService>();

var app = builder.Build();

app.Run();

internal class RaiseEventsBackgroundService(ILogger<RaiseEventsBackgroundService> logger, IServiceScopeFactory serviceScopeFactory) : BackgroundService
{
